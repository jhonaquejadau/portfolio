        ...
        <div  className={`${darkMode ? 'bg-white' : 'bg-[#080916]'} w-full h-full `}>
            ...
            <section className=" flex flex-row justify-center items-center w-full h-[100vh] shadow-xl bg-[rgba(0,0,0,0.3)]">
                <div className="flex flex-col justify-center text-[#2D3142] w-[60%] h-full z-20">
                    ...
                    <h1 className={`${!darkMode ? 'text-slate-500' : 'text-white'} text-[4rem] font-bold text-white text-center uppercase max-[400px]:text-[70px] max-[1000px]:text-[80px]`}>jhon quejada</h1>
                    ...
                    <p className={`${!darkMode ? 'text-slate-400' : 'text-[#2D3142]'} font-bold text-5xl text-center capitalize max-[400px]:text-3xl`}><span className="glowing">mechatronic engineer</span> | <span className="glowing2">react js developer</span></p>
            ...
            <section className="bg-[#080916] flex flex-col justify-center items-center px-[4em] min-[1400px]:flex-row ">
                <div className={`${darkMode ? 'text-white' : 'text-[#080916]'} h-full uppercase text-white text-center z-20`}>
                    <p className={`${!darkMode && 'text-slate-400' } text-[3rem] text-white text-center`}>let me <span className="text-purple-800">introduce</span> myself</p>
