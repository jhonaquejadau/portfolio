        ...
        <div  className="w-full h-full bg-[#080916]">
            ...
            <section className=" flex flex-row justify-center items-center w-full h-[100vh] shadow-xl bg-[rgba(0,0,0,0.3)]">
                <div className="flex flex-col justify-center text-[#2D3142] w-[60%] h-full z-20">
                    ...
                    <h1 className="text-[4rem] font-bold text-white text-center uppercase max-[400px]:text-[70px] max-[1000px]:text-[80px]">jhon quejada</h1>
            ...
            <section className="bg-[#080916] flex flex-col justify-center items-center px-[4em] min-[1400px]:flex-row">
                <div className="h-full uppercase text-white text-center">
                    <p className="text-[3rem] text-white text-center">let me <span className="text-purple-800">introduce</span> myself</p>
